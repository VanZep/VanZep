...
**2. [Note_public](https://github.com/VanZep/Note_public)** - *социальная сеть для публикации заметок и постов.*

<!--<b><i><ins>Стек: Python, Django, html, unittest</ins></i></b>-->

**3. [Note_public_API](https://github.com/VanZep/Note_public_API)** - *REST API для социальной сети Yatube.*
